...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", default="../checkpoints/elc_bert_normalized", type=str, help="The output directory where the model checkpoints will be written.")
    ...
    parser.add_argument("--wandb_name", type=str, default="ELC BERT Normalized")
